            ...
            <div class="card">
                <div class="card-header bg-white border-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="mb-0">Add Spotify API Credentials</h3>
                            <p class="text-muted mb-0">Create new Spotify API credentials</p>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('spotify.credentials.store') }}" class="needs-validation" novalidate autocomplete="on">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control form-control-lg @error('client_secret') is-invalid @enderror" 
                                       ...
                                       placeholder="Enter your Spotify Client Secret" autocomplete="off">
                                @error('client_secret')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-text text-muted">
                                <i class="bi bi-info-circle me-1"></i>
                                Your Client Secret is used to authenticate your application with Spotify
                            </div>
                        </div>
